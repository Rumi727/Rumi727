...
* 1톤까지 문제 없이 들 수 있는 힘
* 반경 128m의 광범위한 중력 조작과 이를 이용한 공중 부양 (Fly)
* 반경 128m의 광범위한 전자기력 조작 및 이를 이용한 염력
  * 참고 : **전자기력**이기에 전기랑 자석도 같이 조작할 수 있다는 점을 간과하지 말자.
* ~~제트팩은 최고야!!!~~ (리썰 컴퍼니 제트팩 상시 사용 가능, 내구도 짱짱해서 절대 안터짐)
* 제한적인 현실 조작
  * 키무 자채는 현실 조작 능력이 **없지만**, 루미에게 부여받은 Ring 0 권한으로 운영체제를 통해 현실 조작을 사용할 수... 있어야했지만
